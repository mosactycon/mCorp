        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {     
                move_uploaded_file($file_tmp, 'preview_project/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                  ...
                  if(!$result){
                    ...
                    echo "<script>alert('Data added successfully.');window.location='your_corp.php';</script>";
                  }

            } else {     
             //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                echo "<script>alert('The only preview extensions allowed are jpg, jpeg, and png.');window.location='your_corp_tambah_produk.php';</script>";
            }
} else {
