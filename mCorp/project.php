...
include 'koneksi.php';
  ...
  if (isset($_GET['id'])) {
    ...
    $data = mysqli_fetch_assoc($result);
      ...
      echo "<script>alert('Data not found in database');window.location='home.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Enter ID data.');window.location='home.php';</script>";
  }         
  ?>
      ...
      <div class="blok">
        ...
        <div class="text content">
          <table>
            ...
            <tr>
              <td>Price</td> <td>: <?php echo $data['harga_project'] ?></td>
