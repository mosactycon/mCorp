...
<body>
	...
	<div class="blok_login">
		...
		<div class="text_login content_login">
			...
			<form action="signup_x.php" method="post">		
				<div>
					...
					<label></label>
					<input type="text" name="kota" placeholder="location">
					<label></label>
			...
			<div>
				<p class="belum_login">Already have an account?<a href="login.php">Log in</a></p>
			</div>
		...
		<div class="image_login content_login"><h2></h2></div>
	</div>
