...
<ul class="horizontal gray">
  ...
  <div class="header"></div>
    ...
    <center><a class="button_tambah" href="your_corp_tambah_produk.php">+ &nbsp; Tambah Project</a><center>
    <br/>
    ...
    <tbody>
      ...
      ?>
       <tr>
          ...
          <td>Rp <?php echo number_format($row['harga_project'],0,',','.'); ?></td>
          ...
          <td>
              ...
              <a  class="editTambah" href="your_corp_proses_hapus.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
      </tr>
